...
#    quotes_quote4: "The feedback … has been so positive that we are structuring a computer science class around CodeCombat. The program really engages the students with a gaming style platform that is entertaining and instructional at the same time. Keep up the good work, CodeCombat!"
    ...
    teach_cs1_free: "Ensina CS1 gratuitamente"
    teachers_love_codecombat_title: "Os professores adoram CodeCombat"
    teachers_love_codecombat_blurb1: "Informam que os seus alunos adoram utilizar CodeCombat para aprender a programar"
    teachers_love_codecombat_blurb2: "Recomendaria CodeCombat a outros professores de ciências da computação"
    teachers_love_codecombat_blurb3: "Dizem que CodeCombat ajuda-os a apoiar os estudantes’ habilidades a resolver problemas"
    teachers_love_codecombat_subblurb: "Em parceria com McREL International, um lider em Investigação-base orientação e avaliações de tecnologia educacional."
    top_banner_blurb: "Novo: entra na nossa missão!"
    try_the_game: "Experimenta o jogo"
    classroom_edition: "Edição de Turma:"
    learn_to_code: "Aprender a programar:"
    play_now: "Jogar Agora"
    im_an_educator: "Sou um Formador"
...
#    purchase_code5: "For more information on Student Licenses, reach out to"
  ...
  ozaria_chrome:
    ...
    sound_on: "Com som"
    back_to_map: "Voltar ao mapa"
    level_options: "Opções de nível"
    restart_level: "Recomeçar nível"
