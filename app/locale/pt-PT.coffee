...
#    classroom_in_box_blurb4: ""
    ...
    top_banner_blurb: "Pais, reservem gratuitamente a primeira aula de programação online ao vivo do vosso filho!"
...
#    apcsp: "AP CS Principles" - Not aplicable in Portugal
  ...
  code_quest:
    great: "Excelente!"
    join_paragraph: "Participe no maior torneio internacional de codificação Python AI (Inteligência Artificial) para todas as idades e dispute o topo da tabela de liderança! Durante este mês, a batalha global começa a 1 de Agosto e inclui prémios no valor de $5k e uma cerimónia de entrega de prémios virtual onde anunciaremos os vencedores e reconheceremos as suas capacidades de programação."
    link: "Clique aqui para se registar e saber mais"
    global_tournament: "Torneio Global"
    register: "Registe-se"
    date: "1 - 31 de Agosto"
  ...
  special_offer:
    ...
    project_based_title: "Cursos com base em projectos"
    project_based_description: "Os cursos de Desenvolvimento de Web e Jogos apresentam projectos finais partilháveis."
    great_for_clubs_title: "Óptimo para grupos de estudo e candidatos ao ensino secundário"
    great_for_clubs_description: "Os professores podem adquirir até __maxQuantityStarterLicenses__ Licenças de Iniciação."
    low_price_title: "Apenas __starterLicensePreço__ por estudante"
    low_price_description: "Licenças de Iniciação estão activas durante __starterLicenceLengthMonths__ meses da compra."
    three_great_courses: "Três grandes cursos incluídos na Licença de Iniciação:"
    license_limit_description: "Os professores podem adquirir até __maxQuantityStarterLicenses__ Licenças de Iniciação. Já adquiriu __quantityAlreadyPurchased__. Se precisar de mais, contacte __supportEmail__. As Licenças de Iniciação são válidas por __starterLicenseLicenseMonths__ meses."
    student_starter_license: "Licença de Iniciação para Estudantes"
    purchase_starter_licenses: "Adquirir Lincenças de Iniciação"
    purchase_starter_licenses_to_grant: "Adquirir licenças de iniciação para conceder acesso a __starterLicenseCourseList__"
    starter_licenses_can_be_used: "As licenças de iniciação podem ser utilizadas para atribuir cursos adicionais imediatamente após a compra."
    pay_now: "Pagar agora"
    we_accept_all_major_credit_cards: "Aceitamos todos os principais cartões de crédito."
    cs2_description: "baseia-se nos fundamentos da Introdução à Ciência da Computação, mergulhando em \"if-statements\", funções, eventos e muito mais."
    wd1_description: "introduz as noções básicas de HTML e CSS enquanto ensina as aptidões necessárias para os estudantes construírem a sua primeira página web."
    gd1_description: "utiliza a sintaxe com que os estudantes já estão familiarizados para lhes mostrar como construir e partilhar os seus próprios níveis de jogo."
    see_an_example_project: "ver um exemplo de projecto"
    get_started_today: "Comece já hoje!"
    want_all_the_courses: "Quer todos os cursos? Solicite informações sobre as nossas licenças completas."
    compare_license_types: "Comparar tipos de licença:"
    cs: "Ciência da Computação"
    wd: "Criação de Páginas Web"
    wd1: "Criação de Páginas Web 1"
    gd: "Criação de jogos"
    gd1: "Criação de jogos 1"
    maximum_students: "Nº máximo de alunos"
    unlimited: "Ilimitado"
    priority_support: "Apoio prioritário"
    yes: "Sim"
...
#    course_suffix: ""
  ...
  teachers_quote:
    subtitle: "Saiba mais sobre o CodeCombat com um tour interactivo pelo produto, preços, e implementação!"
    email_exists: "O utilizador existe com este e-mail."
    ...
    primary_role_default: "Seleccionar o cargo principal"
    purchaser_role_default: "Seleccionar o Cargo de Comprador"
    tech_coordinator: "Coordenador de Tecnologia"
    advisor: "Especialista/Perito de Curriculum"
    principal: "Diretor"
    superintendent: "Superintendente"
    parent: "Educador"
    purchaser_role_label: "O seu cargo de Comprador"
    influence_advocate: "Influência/Advogação"
    evaluate_recommend: "Avaliar/Recomendar"
    approve_funds: "Aprovação de Fundos"
    no_purchaser_role: "Nenhum cargo nas decisões de compra"
    ...
    elementary_school: "Ensino Básico"
    high_school: "Ensino Secundário"
    please_explain: "(por favor, explica)"
#    middle_school: "Middle School"
    college_plus: "Universidade ou superior"
    ...
    referrer_conference: "Conferência (e.g. ISTE)"
    ...
    referrer_pd: "Formações/workshops profissionais"
    referrer_web: "Google"
    referrer_other: "Outro"
    anything_else: "Para que tipo de disciplina prevê usar o CodeCombat?"
#    anything_else_helper: ""
    thanks_header: "Pedido Recebido!"
    thanks_sub_header: "Obrigado por manifestar interesse no CodeCombat para a sua escola."
    thanks_p: "Entraremos em contacto em breve! Se necessitar de mais informação, pode contactar-nos através de:"
    back_to_classes: "Voltar às Turmas"
    finish_signup: "Termine de criar a sua conta de professor:"
    finish_signup_p: "Crie uma conta para preparar uma turma, adicione os seus alunos e acompanhe o seu progresso à medida que aprendem ciência da computação."
    signup_with: "Inscreva-se com:"
    connect_with: "Conectar com:"
    conversion_warning: "AVISO: A sua conta corrente é uma <em>Conta de Estudante</em>. Uma vez submetido este formulário, a sua conta será actualizada para uma Conta de Professor."
    learn_more_modal: "As contas de professor no CodeCombat têm a capacidade de monitorizar o progresso dos alunos, atribuir licenças e gerir turmas. As contas de professor não podem fazer parte de uma turma - se estiver actualmente inscrito numa, utilizando esta conta, deixará de poder aceder à mesma uma vez que a actualize para uma conta de professor."
    ...
    convert_account_title: "Actualizar para Conta de Professor"
    not: "Não"
    full_name_required: "Nome e apelido necessários"
  ...
  clans:
    title: "Junte-se aos Clãs do CodeCombat - Aprenda a codificar em Python, JavaScript, e HTML"
    clan_title: "__clan__ - Junte-se aos Clãs do CodeCombat e Aprenda a Programar"
    meta_description: "Junta-te a um Clã ou constrói a tua própria comunidade de programadores. Joga os níveis na arena multi-jogador e melhora o teu herói e as tuas capacidades de programação."
    clan: "Clã"
    clans: "Clãs"
  ...
  courses:
    ...
    hoc_blurb1: "Experimenta o"
    hoc_blurb2: "Programa, Joga, Partilha"
    hoc_blurb3: "actividade! Constrói quatro minijogos diferentes para aprender as bases do processo de criação de jogos, depois cria o teu!"
    ...
    stats: "Estatísticas"
    student_email_invite_blurb: "Os seus alunos também podem utilizar o código de turma <strong>__classCode__</strong> ao criar uma Conta de Estudante, não é necessário enviar um e-mail."
    ...
    assign: "Atribuir"
    to_assign: "para atribuir cursos pagos."
    student: "Estudante"
    teacher: "Professor"
    arena: "Arena"
    ...
    play_now_learn_1: "sintaxe básica para controlar o teu personagem"
    play_now_learn_2: "while loops para solucionar os puzzles mais incómodos"
    play_now_learn_3: "strings & variáveis para personalizar acções"
    play_now_learn_4: "como derrotar um ogre (habilidades importantes para a vida!)"
    ...
    remove_description1: "O aluno perderá o acesso a esta turma e às aulas que lhe foram atribuídas. O progresso e a actividade de jogo NÃO se perdem, e o aluno pode ser acrescentado de volta à turma em qualquer altura."
    remove_description2: "O valor da licença activada não será devolvido."
    license_will_revoke: "A licença paga a este aluno será revogada e disponibilizada para ser atribuída a outro aluno."
    ...
    changelog: "Ver as últimas alterações aos níveis dos cursos."
    ...
    estimated_class_dates_label: "Datas estimadas para a aula"
    estimated_class_frequency_label: "Frequência Estimada para as Aulas"
    classes_per_week: "aulas por semana"
    minutes_per_class: "minutos por aula"
    create_class: "Criar Turma"
    class_name: "Nome da Turma"
    teacher_account_restricted: "A sua conta é uma conta de professor e não pode aceder ao conteúdo das contas de alunos."
    account_restricted: "É necessária uma conta de estudante para acederes a esta página."
    update_account_login_title: "Inicie sessão para actualizar a sua conta"
    update_account_title: "A tua conta precisa de atenção!"
    update_account_blurb: "Antes de ter acesso às tuas aulas, escolhe como queres utilizar esta conta."
    update_account_current_type: "Tipo de conta atual:"
    update_account_account_email: "Conta de Email/Nome de Utilizador:"
    update_account_am_teacher: "Sou um professor"
    update_account_keep_access: "Manter o acesso às turmas que eu criei"
    update_account_teachers_can: "As contas de professor podem:"
    update_account_teachers_can1: "Criar/administrar/adicionar turmas"
    update_account_teachers_can2: "Atriubuir/matricular alunos nos cursos"
    update_account_teachers_can3: "Desbloquear todos os níveis do curso para experimentar"
    update_account_teachers_can4: "Aceder a novas funcionalidades só para professores à medida que as divulgamos"
    update_account_teachers_warning: "Aviso: Será retirado de todas as turmas às quais já tenha aderido anteriormente e não poderá jogar como aluno."
    update_account_remain_teacher: "Continuar Professor"
    update_account_update_teacher: "Atualizar para Professor"
    update_account_am_student: "Sou um estudante"
    update_account_remove_access: "Remover o acesso às turmas que eu criei"
    update_account_students_can: "As contas dos estudantes podem:"
    update_account_students_can1: "Junte-se a turmas"
    update_account_students_can2: "Joga os percursos como estudante e acompanha o teu próprio progresso"
    update_account_students_can3: "Competir contra colegas de turma em arenas"
    update_account_students_can4: "Aceder a novas funcionalidades apenas para estudantes à medida que as divulgamos"
    update_account_students_warning: "Advertência: Não poderá gerir quaisquer turmas que tenha anteriormente criado ou criar novas turmas."
    unsubscribe_warning: "Advertência: Será cancelada a sua assinatura mensal."
    update_account_remain_student: "Permanecer estudante"
    update_account_update_student: "Actualização para Estudante"
    need_a_class_code: "Vai precisar de um Código de Turma para a turma a que se vai juntar:"
    update_account_not_sure: "Não tem a certeza de qual escolher? Email"
    update_account_confirm_update_student: "Tem a certeza que quer actualizar a sua conta para uma de Estudante?"
    update_account_confirm_update_student2: "Não será capaz de gerir quaisquer turmas que tenha anteriormente criado ou criar novas turmas. As suas turmas anteriormente criadas serão removidas do CodeCombat e não poderão ser restauradas."
    instructor: "Formador: "
    youve_been_invited_1: "Foi convidado a juntar-se a "
    youve_been_invited_2: ", onde irá aprender "
    youve_been_invited_3: " com os seus colegas de turma no CodeCombat."
    by_joining_1: "Ao aderir "
    by_joining_2: "poderá ajudar a redefinir a sua palavra-passe caso se esqueça ou a perca. Poderá também verificar o seu endereço de correio electrónico para que possa redefinir a palavra-passe você mesmo!"
    sent_verification: "Enviámos um e-mail de verificação para:"
    you_can_edit: "Pode editar o seu endereço de correio electrónico em "
    ...
    web_dev_language_transition: "O programa de todas as turmas de HTML / JavaScript para este curso.  As turmas que têm vindo a usar Python começarão com níveis de introdução extra em JavaScript para facilitar a transição.  As turmas que já estão a utilizar JavaScript saltarão os níveis de introdução."
    course_membership_required_to_play: "Precisas de te juntar a um curso para jogares este nível."
    license_required_to_play: "Pede ao teu professor para te atribuir uma licença para que possas continuar a jogar CodeCombat!"
    update_old_classroom: "Novo ano escolar, novos níveis!"
    update_old_classroom_detail: "Para se assegurar de que está a obter os níveis mais recentes, certifique-se de criar uma nova turma para este semestre, clicando em Criar uma Nova Turma no seu"
    teacher_dashboard: "painel do professor"
    update_old_classroom_detail_2: "e dando aos alunos o novo Código de Turma que aparece."
    view_assessments: "Ver Avaliações"
    view_challenges: "ver níveis de desafio"
    view_ranking: "ver classificação"
    ranking_position: "Posição"
    ranking_players: "Jogadores"
    ranking_completed_leves: "Níveis concluídos"
    challenge: "Desafio:"
    ...
    keep_trying: "Continua a tentar"
    start_challenge: "Começar Desafio"
    locked: "Bloqueado"
    concepts_used: "Conceitos Usados:"
    show_change_log: "Mostrar alterações aos níveis deste curso"
    hide_change_log: "Ocultar alterações aos níveis deste curso"
    concept_videos: "Vídeos de Conceito"
    concept: "Conceito:"
    basic_syntax: "Sintaxe básica"
    while_loops: "While Loops"
    variables: "Variáveis"
    basic_syntax_desc: "A sintaxe é a forma como escrevemos código. Tal como a ortografia e a gramática são importantes na escrita de narrativas e ensaios, a sintaxe é importante quando programamos. Os humanos são bons a descobrir o que qualquer coisa significa, mesmo que não seja exactamente correcta, mas os computadores não são assim tão inteligentes, e precisam que se escreva com muita precisão."
    while_loops_desc: "Um loop é uma forma de repetir acções num programa. Podes utilizá-los para não teres de continuar a escrever código que se repete, e quando não souberes exactamente quantas vezes uma acção terá de ocorrer para realizar uma tarefa."
    variables_desc: "Trabalhar com variáveis é como organizar as coisas em caixas de sapatos. Dá-se um nome à caixa de sapatos, como \"Material escolar\", e depois põe-se coisas lá dentro. O conteúdo exacto da caixa pode mudar com o tempo, mas o que quer que esteja dentro será sempre chamado de \"Material Escolar\". Em programação, as variáveis são símbolos utilizados para armazenar dados que irão mudar ao longo do programa. As variáveis podem conter uma variedade de tipos de dados, incluindo números e cadeias de caracteres (strings)."
    locked_videos_desc: "Continue a jogar o jogo para desbloquear o __concept_name__ conceito de vídeo."
    unlocked_videos_desc: "Reveja o __concept_name__ conceito de vídeo."
    video_shown_before: "mostrado antes __level__"
    link_google_classroom: "Ligar a sala de aula do Google"
    select_your_classroom: "Seleccione a sua sala de aula"
    no_classrooms_found: "Não foram encontradas salas de aula"
    create_classroom_manually: "Criar sala de aula manualmente"
    classes: "Turmas"
    certificate_btn_print: "Imprimir"
    certificate_btn_toggle: "Alternar"
    ask_next_course: "Queres jogar mais? Solicita ao teu professor o acesso ao próximo curso."
    set_start_locked_level: "Atribuir até ao nível"
#    no_level_limit: "--"
  ...
  teacher:
    assigning_course: "Atribuição de curso"
    back_to_top: "Voltar ao Topo"
    click_student_code: "Clique em qualquer nível que o estudante tenha iniciado ou concluído abaixo para ver o código que escreveu."
    code: "Código de __name__"
    complete_solution: "Solução Completa"
    course_not_started: "O aluno ainda não iniciou este curso."
    appreciation_week_blurb1: "Para <strong>Semana de Apreciação de Professores 2019</strong>, estamos a oferecer licenças gratuitas de 1 semana!<br />Email Rob Arevalo (<a href=\"mailto:robarev@codecombat.com?subject=Teacher Appreciation Week\">robarev@codecombat.com</a>) com linha de assunto \"<strong>Semana de Apreciação do Professor</strong>\", e incluir:"
    appreciation_week_blurb2: "a quantidade de licenças de 1 semana que deseja (1 por estudante)"
    appreciation_week_blurb3: "o endereço de correio electrónico da sua conta de professor CodeCombat"
    appreciation_week_blurb4: "quer deseje licenças para a Semana 1 (6-10 de Maio) ou para a Semana 2 (13-17 de Maio)"
    hoc_happy_ed_week: "Feliz Semana de Educação em Ciência da Computação!"
    hoc_blurb1: "Saiba mais sobre o que é gratuito"
    hoc_blurb2: "Programa, Joga, Partilha"
    hoc_blurb3: "actividade, descarregue um novo plano de aula para professores, e diga aos seus alunos para entrarem para jogar!"
    hoc_button_text: "Ver Actividade"
    no_code_yet: "O estudante ainda não escreveu nenhum código relativo a este nível."
    open_ended_level: "Nível Aberto"
    partial_solution: "Solução Parcial"
    capstone_solution: "Solução do Marco"
    removing_course: "A remover o curso"
    solution_arena_blurb: "Os estudantes são encorajados a resolver os níveis da arena de forma criativa. A solução fornecida abaixo satisfaz os requisitos do nível da arena."
    solution_challenge_blurb: "Os estudantes são encorajados a resolver níveis de desafio livres de forma criativa. Uma solução possível é apresentada abaixo."
    solution_project_blurb: "Os estudantes são encorajados a construir um projecto criativo neste nível. Consulte os guias curriculares no Centro de Recursos para obter informações sobre como avaliar estes projectos."
    students_code_blurb: "É fornecida uma solução correcta para cada nível, quando apropriado. Em alguns casos, é possível a um estudante resolver um nível utilizando código diferente. Não são mostradas soluções para níveis que o aluno não tenha iniciado."
    course_solution: "Solução do Curso"
    level_overview_solutions: "Visão geral e soluções do nível"
    no_student_assigned: "Nenhum estudante foi designado para este curso."
    paren_new: "(novo)"
    ...
    teacher_account_explanation: "Uma conta Professor CodeCombat permite-lhe criar salas de aula, monitorizar o progresso dos alunos à medida que estes trabalham através dos cursos, gerir licenças e aceder a recursos para ajudar na construção do seu currículo."
    ...
    view_student_code: "Clique para ver o código do estudante"
    ...
    students_not_assigned: "Estudantes que não foram atribuídos {{courseName}}"
    ...
    assigned_msg_1: "{{numberAssigned}} estudantes foram atribuídos {{courseName}}."
    assigned_msg_2: "{{numberEnrolled}} licenças foram aplicadas."
    assigned_msg_3: "Agora tem {{remainingSpots}} licenças disponíveis restantes."
    ...
    not_assigned_modal_starter_body_1: "Este curso requer uma Licença Inicial. Não tem Licenças Iniciais suficientes para atribuir este curso a todos __selected__ alunos seleccionados."
    not_assigned_modal_starter_body_2: "Adquirir Licenças de Iniciação para conceder acesso a este curso."
    not_assigned_modal_full_body_1: "Este curso requer uma Licença Integral. Não tem Licenças Integrais suficientes disponíveis para atribuir este curso a todos __selected__ alunos seleccionados."
    not_assigned_modal_full_body_2: "Você apenas tem __numFullLicensesAvailable__ Licenças Integrais disponíveis (__numStudentsWithoutFullLicenses__ os estudantes não têm actualmente uma licença integral activa)."
    not_assigned_modal_full_body_3: "Por favor seleccione menos estudantes, ou contacte __supportEmail__ para assistência."
    assigned: "Atribuído"
    ...
    students_have_licenses: "Os seguintes estudantes já têm licenças válidas:"
    ...
    send_email_to: "Enviar E-mail de recuperação de senha para:"
    ...
    student_enrollment_history: "História da inscrição de estudantes"
    enrollment_explanation_1: "O"
    enrollment_explanation_2: "História da inscrição de estudantes"
    enrollment_explanation_3: "exibe o número total de alunos que estiveram matriculados por todos os professores e turmas adicionadas ao seu painel de controlo. Isto inclui alunos tanto em turmas arquivadas como não arquivadas, com uma data de criação de turmas entre 1 de Julho e 30 de Junho de cada ano lectivo respectivo.."
    enrollment_explanation_4: "Não esquecer"
    enrollment_explanation_5: "as aulas podem ser arquivadas e as licenças podem ser reutilizadas ao longo do ano lectivo, pelo que esta visão permite aos administradores compreender quantos alunos participaram verdadeiramente no programa em geral."
    ...
    how_to_apply_licenses_blurb_1: "Quando um professor atribui um curso a um aluno pela primeira vez, aplicamos automaticamente uma licença. Utilize o dropdown de atribuição em massa na sua turma para atribuir um curso a alunos seleccionados:"
    how_to_apply_licenses_blurb_2: "Posso ainda aplicar uma licença sem atribuir um curso?"
    how_to_apply_licenses_blurb_3: "Sim - vá para o separador Estado da Licença na sua sala de aula e clique \"Atribuir Licença\" a qualquer estudante que não tenha uma licença activa."
    request_sent: "Pedido Enviado!"
    assessments: "Avaliações"
    license_status: "Estado das Licenças"
    status_expired: "Expirou em {{date}}"
    status_not_enrolled: "Não Inscrito"
    status_enrolled: "Expira em {{date}}"
    select_all: "Selecionar Todos"
    project: "Projeto"
    project_gallery: "Galeria do Projecto"
    view_project: "Ver Projeto"
    unpublished: "(não publicado)"
    view_arena_ladder: "Ver Escada da Arena"
    resource_hub: "Centro de Recursos"
    pacing_guides: "Guias de embalagem para sala de aula numa caixa"
    pacing_guides_desc: "Aprenda a incorporar todos os recursos do CodeCombat para planear o seu ano lectivo!"
    pacing_guides_elem: "Guia de Acompanhamento para o ensino básico"
    pacing_guides_middle: "Guia de Acompanhamento para o ensino preparatório"
    pacing_guides_high: "Guia de Acompanhamento para o ensino secundário"
    getting_started: "Começar"
    educator_faq: "FAQ do Educador"
    educator_faq_desc: "Perguntas mais frequentes sobre a utilização do CodeCombat na sua turma ou escola."
    teacher_getting_started: "Guia de iniciação do professor"
    teacher_getting_started_desc: "É novo no CodeCombat? Descarregue este Manual de Iniciação do Professor para configurar a sua conta, criar a sua primeira aula, e convidar os alunos para o primeiro curso."
    student_getting_started: "Guia de Início Rápido do Estudante"
